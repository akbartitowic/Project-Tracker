...
export default function RealizationReport() {
    ...
    return (
        <div className="p-8 max-w-[1450px] mx-auto pb-20">
            <div className="flex flex-col gap-2 mb-8">
                <h1 className="text-3xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                    <TrendingUp className="size-7 text-primary" /> Realization Report
                </h1>
                <p className="text-slate-500 dark:text-slate-400">
                    Ringkasan finance per project: pemasukan awal, top up, planning expense/income, sisa margin, dan persentase margin.
                </p>
            </div>
                ...
                <CardHeader className="pb-4">
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <CardDescription>Menampilkan semua project beserta summary finance final.</CardDescription>
                        </div>
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
                                {loading ? (
                                    ...
                                    <tr><td colSpan="8" className="py-10 text-center text-slate-400">Tidak ada data project.</td></tr>
                                ) : (
